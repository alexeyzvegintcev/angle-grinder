(function() {
    ...
    forms = angular.module("angleGrinder.forms", [ "ui.bootstrap.collapse", "ui.bootstrap.accordion", "ui.bootstrap.alert", "ui.bootstrap.buttons", "ui.bootstrap.carousel", "ui.bootstrap.dateparser", "ui.bootstrap.position", "ui.bootstrap.dropdown", "ui.bootstrap.stackedMap", "ui.bootstrap.modal", "ui.bootstrap.pagination", "ui.bootstrap.progressbar", "ui.bootstrap.rating", "ui.bootstrap.tabs", "ui.bootstrap.tpls", "ui.bootstrap.tooltip", "xeditable", "angleGrinder.common", "angleGrinder.alerts", "formly", "formlyBootstrap" ]);
    forms.run([ "$templateCache", function($templateCache) {
        ...
        return $templateCache.put("datepicker.html", '<ag-datepicker date-type="date"\n                   ng-model="model"\n\n                   name="datepick"/>\n        </ag-datepicker>');
    } ]);
    forms.run([ "formlyConfig", function(formlyConfig) {
        var attributes, bindings, camelize, ngModelAttrs;
        attributes = [ "date-disabled", "custom-class", "show-weeks", "starting-day", "init-date", "min-mode", "max-mode", "format-day", "format-month", "format-year", "format-day-header", "format-day-title", "format-month-title", "year-range", "shortcut-propagation", "datepicker-popup", "show-button-bar", "current-text", "clear-text", "close-text", "close-on-date-selection", "datepicker-append-to-body" ];
